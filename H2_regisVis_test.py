...
class H1_inicio_index_test(unittest.TestCase):
    ...
    def test_inicio_index(self):
        try:
            ...
            self.driver.save_screenshot("fotos_pr\\registro_registro.png")
...
if __name__ == '__main__':
    unittest.main(
        testRunner=HtmlTestRunner.HTMLTestRunner(
            output='reportes_pr',
            report_name='Reporte_registro_Proyecto_Personal',
            report_title='Reporte de prueba - Registro del sistema',
