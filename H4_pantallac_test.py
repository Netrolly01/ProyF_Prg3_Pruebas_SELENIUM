...
class H4_pantallac_test(unittest.TestCase):
    ...
    def test_pantalla_completa_video(self):
        try:
            ...
            # Poner el video en pantalla completa con la tecla 'f'
            ...
            self.driver.save_screenshot("fotos_pr\\H4_pantallac_programacion_python.png")
...
if __name__ == '__main__':
    unittest.main(
        testRunner=HtmlTestRunner.HTMLTestRunner(
            output='reportes_pr',
            report_name='Reporte_Pantalla_Completa_Programacion_Python',
            report_title='Reporte Pantalla Completa Video',
            descriptions=True
        )
    )
